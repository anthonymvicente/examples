...
// here we get each row and initialize the cards in the row
// each row must be separately initialized since the first/last cards
// of each row must operate appropriately
// if you only have one row, you can just run the function above straight from loading
